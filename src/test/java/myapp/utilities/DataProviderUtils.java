...
public class DataProviderUtils {
    ...
    //    Data Provider to get the user credentials from the EXCEL SHEET called 'user_data' (for Day26_DataProvider2 class)
    ...
    //    Data Provider to get the user credentials from the EXCEL SHEET called 'admin_credentials'
    @DataProvider        // to enable parallel testing we use (parallel = true) parameter
